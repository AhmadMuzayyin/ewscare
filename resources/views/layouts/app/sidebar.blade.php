    ...
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.group :heading="__('Master')" class="grid">
                ...
                <flux:sidebar.item icon="user" :href="route('santri.index')"
                    :current="request()->routeIs('santri.index')" wire:navigate>
                    {{ __('Santri') }}
                </flux:sidebar.item>
                <flux:sidebar.item icon="home" :href="route('gejala.index')"
                    :current="request()->routeIs('gejala.index')" wire:navigate>
                    {{ __('Gejala') }}
                </flux:sidebar.item>
                <flux:sidebar.item icon="home" :href="route('penyakit.index')"
            ...
            <flux:sidebar.group :heading="__('Utiliti')" class="grid">
                <flux:sidebar.item icon="circle-stack" :href="route('dataset.index')"
                    :current="request()->routeIs('dataset.index')" wire:navigate>
                    {{ __('Dataset') }}
                </flux:sidebar.item>
